    ...
    <section className="py-16 md:py-24 lg:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-20">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-light text-gray-900 mb-4">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-rose-500 text-white px-3 py-1 rounded-2xl text-sm font-medium">
                      {service.category}
                    </span>
                  </div>
                </div>
                <div className="p-5 sm:p-6">
                  ...
                  <Link
                    ...
                    className="w-full bg-rose-500 text-white py-2 px-4 rounded-2xl hover:bg-rose-600 transition-colors text-center block"
                  >
                    Book Now
                  </Link>
                </div>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 bg-white shadow-lg rounded-2xl p-3 hover:shadow-xl transition-all z-10 hover:bg-gray-50 active:scale-95"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 bg-white shadow-lg rounded-2xl p-3 hover:shadow-xl transition-all z-10 hover:bg-gray-50 active:scale-95"
        ...
        <div className="text-center mt-14">
          <Link
            ...
            className="inline-flex items-center px-8 py-3.5 border-2 border-rose-500 text-rose-500 font-medium rounded-2xl hover:bg-rose-500 hover:text-white transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
          >
